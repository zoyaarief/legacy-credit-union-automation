...
export const ROLE_CAPABILITIES: Record<AutomationRole, string[]> = {
  admin: ["manage_roles", "submit_artifacts", "review_artifacts", "operate_jobs", "enqueue_jobs", "invoke_capabilities", "view_operations", "dispatch_alerts"], reviewer: ["review_artifacts", "view_operations"], operator: ["operate_jobs", "view_operations"], agent: ["submit_artifacts", "enqueue_jobs", "invoke_capabilities"], viewer: [],
};
